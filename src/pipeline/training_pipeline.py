...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info(
                "Exited the start data ingestion method od TrainPipeline class"
            )
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        ...
        """
        logging.info("Entering the star_data_validation method of TrainPipeline class")
    ...
    def start_model_evaluation(self, data_ingestion_artifact: DataIngestionArtifact, model_trainer_artifact: ModelTrainerArtifact) -> ModelEvaluationArtifact:
        ...
        try:
            ...
            model_evaluation_artifact = model_evaluation.intiate_model_evaluation()
