...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        Including gender mapping, dummy variable creation, column renaming, feature scaling,
        and type adjustments
        """
        logging.info("Entered get_data_transformer_object methof of DataTransformation class")
        
        try:
            # Initialize transformers
            numeric_transformer = StandardScaler()
            min_max_scaler = MinMaxScaler()
            logging.info("Transformer initiated: StandardScaler and MinMaxScaler")
    ...
    def _create_dummy_columns(self, df):
        """ Map dummy variables for categorical features. """
    ...
    def _rename_columns(self, df):
        """ 
        Create dummy columns and ensure integer types for dummy columns.
        """
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            logging.info("Input and Target columns defined for both train and test dataframe.")
            ...
            logging.info("Transformation done end-to-end to test and train df.")
