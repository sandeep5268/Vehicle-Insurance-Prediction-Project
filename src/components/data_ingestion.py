...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame) -> None:
        ...
        """
        logging.info("Entereed split_data_as_train_test method of Dat_ingestion class")
        
        try:
           train_set, test_set = train_test_split(dataframe, test_size=self.data_ingestion_config.train_test_split_ratio)
           logging.info("Performed train test split on the dataframe")
           logging.info(
               "Exited split_data_as_train_test method of Data _Ingestion class"
           ) 
           ...
           logging.info(f"Exported train and test file path")
            ...
            raise MyException(e, sys) from exit
        
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        """ 
        Method name : initiate_data_ingestion
        Description : This method intiaties the data ingestion components of training pipeline
